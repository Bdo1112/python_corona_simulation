...
from population import initialize_destination_matrix,\
set_destination_bounds, save_data, save_population, Population_trackers
from population import InitializePopulation
...
class Simulation():
    ...
    def population_init(self):
        ...
        self.population = InitializePopulation.initialize_population(self.Config, self.Config.mean_age, 
