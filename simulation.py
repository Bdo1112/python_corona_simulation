...
class Simulation():
    ...
    def tstep(self):
        ...
        if active_dests > 0 and len(self.population[self.population[:,12] == 0]) > 0:
            self.population = Destination.set_destination(self.population, self.destinations)
            self.population = Destination.check_at_destination(self.population, self.destinations,
        ...
        if active_dests > 0 and len(self.population[self.population[:,12] == 1]) > 0:
            ...
            self.population = Destination.keep_at_destination(self.population, self.destinations,
