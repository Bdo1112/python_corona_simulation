...
class Destination:
    ...
    #Destination is one of important factor in this project which it decide where to travel for the population which would make huge impact on the result of the simulation
