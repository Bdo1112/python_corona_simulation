...
class Population():
    #put initialize_population, save popuation, and population_tracker to ease of managing the domain by having aggregated design pattern
    #initializing first with initialize_population, save its related date with save_population
...
class Environment():
    ...
    #Created Enviroment class(root) to creat aggregate design pattern
