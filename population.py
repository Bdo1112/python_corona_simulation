...
class InitializePopulation:
    ...
    instance = None
    def __init__(self, arg):
        if not InitializePopulation.instance:
            InitializePopulation.instance = InitializePopulation.__initializePopulation(arg)
        else:
            InitializePopulation.instance().val = arg
